...
- (BOOL) DoActionWithSuccess:(ActionSuccessBlock) success Failure:(ActionFailureBlock) failure
{
    ...
    if( self.upload_image )
    {
        ...
        {
            upload_file_url = [HIUntil createTempImageUploadFile:self.upload_image];
        }
        else
        {
            upload_file_url = [HIUntil createTempImageUploadFile:self.upload_image WithMaxSize:self.upload_image_max_size];
        }
    }
